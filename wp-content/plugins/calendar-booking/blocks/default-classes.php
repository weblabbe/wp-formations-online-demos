...
class CBSB_Block_Default_Group {
	public $slug = 'calendar-booking/default-classes-flow';
	...
	function register_styles() {
		wp_register_style(
			'cbsb-default-classes-flow-editor-style',
	...
	function register_scripts() {
		...
		wp_register_script(
			'cbsb-default-classes-flow-editor',
			CBSB_BASE_URL . 'public/js/blocks/default-classes.js',
	...
	function register_block() {
		register_block_type( $this->slug, array(
			'editor_style'  => 'cbsb-default-classes-flow-editor-style',
			'editor_script' => 'cbsb-default-classes-flow-editor',
			'script'        => 'cbsb-default-classes-flow',
			'style'         => 'cbsb-default-classes-flow-style'
		) );
	}
}
add_action( 'init', array( new CBSB_Block_Default_Group, 'init' ) );
